...
class FollowersControllerTest < ActionController::TestCase
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post :create, follower: { user_id_follower: @follower.user_id_follower, user_id_model: @follower.user_id_model }
    end
  ...
  test "should update follower" do
    put :update, id: @follower, follower: { user_id_follower: @follower.user_id_follower, user_id_model: @follower.user_id_model }
    assert_redirected_to follower_path(assigns(:follower))
  end
